...
//unit testing for FindLowestDifference
        ...
        try {
            ...
            assertEquals(FindLowestDifference.findSmallestDifference(array1,array2,3,3),2);
        ...
        try {
            assertEquals(Factorial.factRecursion(5),120);
        ...
        try{
            ...
            assertEquals(LowestNumber.lowest(array),5);
        ...
        try{//Unit testing for missing number
            ...
            int n = 4;
            assertEquals(FindMissingNumber.pickMissingNum(array,n),3);
        ...
        try {
            ...
            assertEquals(Pattern.findPattern(n), expectedArray);
